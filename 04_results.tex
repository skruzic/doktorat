...
\begin{table}
    ...
    \begin{tabular}{cccc}
        ...
        8. & 0.4868 & 0.4776 & \textbf{0.2740}\\ % lstm_01
...
\begin{figure}
    \centering
    \subfloat[Arch. \#2\label{fig:SimGraph01}]{
        \includegraphics[width=0.47\textwidth]{slike/mdpi/sim_mlp03_006.png}
    }
    \hfill
    \subfloat[Arch. \#3\label{fig:SimGraph02}]{
        \includegraphics[width=0.47\textwidth]{slike/mdpi/sim_mlp04_021.png}
    }
    \vfill
    \subfloat[Arch. \#4\label{fig:SimGraph03}]{
        \includegraphics[width=0.47\textwidth]{slike/mdpi/sim_conv01_006.png}
    }
    \hfill
    \subfloat[Arch. \#6\label{fig:SimGraph04}]{
        \includegraphics[width=0.47\textwidth]{slike/mdpi/sim_conv03_021.png}
    }
    \vfill
    \subfloat[Arch. \#7\label{fig:SimGraph05}]{
        \includegraphics[width=0.47\textwidth]{slike/mdpi/sim_lstm03_006.png}
    }
    \hfill
    \subfloat[Arch. \#9\label{fig:SimGraph06}]{
        \includegraphics[width=0.47\textwidth]{slike/mdpi/sim_lstm02_021.png}
    }
...
\begin{table}
    ...
    \begin{tabular}{|c|c|c|c|}
        ...
        \hline
        5. & 6.1087 & 6.2422 & \textbf{1.3203} \\ % conv_02
        \hline
...
\begin{figure}
    \centering
    \subfloat[Arch. \#1\label{fig:RealGraph01}]{\includegraphics[width=0.45\columnwidth]{slike/franka_mlp04_003.png}}
    \hfil
    \subfloat[Arch. \#2\label{fig:RealGraph02}]{\includegraphics[width=0.45\columnwidth]{slike/franka_mlp05_037.png}}
    \vfil
    \subfloat[Arch. \#6\label{fig:RealGraph03}]{\includegraphics[width=0.45\columnwidth]{slike/franka_conv03_003.png}}
    \hfil
    \subfloat[Arch. \#4\label{fig:RealGraph04}]{\includegraphics[width=0.45\columnwidth]{slike/franka_conv01_037.png}}
    \vfil
    \subfloat[Arch. \#8\label{fig:RealGraph05}]{\includegraphics[width=0.45\columnwidth]{slike/franka_lstm02_003.png}}
    \hfil
    \subfloat[Arch. \#9\label{fig:RealGraph06}]{\includegraphics[width=0.45\columnwidth]{slike/franka_lstm03_037.png}}
...
\begin{table}
    ...
    \begin{tabular}{ccccc}
        ...
        \midrule
        1. & DeLaN & Sim (no ext.) & 1.6629 & 0.6871 \\ % lnn_prazni_02
        2. & DeLaN & Sim (with ext.) & 1.2137 & 0.7475 \\ % lnn_teret_02
        3. & MLP & Sim (with ext.) & 1.4076 & 1.0287 \\ % mlp_tau_01
        4. & Conv & Sim (with ext.) & 1.1420 & 0.9144 \\ % conv_teret_torque_01
        5. & LSTM & Sim (with ext.) & 0.6236 & \textbf{0.6189}\\ % lstm_teret_torque_01
        \midrule
        6. & DeLaN & Real & 1.2398 & 0.8468\\ % lnn_franka_01
        7. & MLP & Real & 1.8995 & 1.1567\\% mlp_franka_torque_01
        8. & Conv & Real & 1.4837 & 0.9552\\ % conv_franka_torque_01
        9. & LSTM & Real & 1.0385 &\textbf{0.7778}\\ % lstm_franka_torque_01
        \bottomrule
    \end{tabular}
\end{table}
...
%\begin{figure}
    %\centering
    %\subfloat{\includegraphics[width=0.45\textwidth]{slike/mdpi/prazni_delan_002.png}}
    %\hfill
    %\subfloat{\includegraphics[width=0.45\textwidth]{slike/mdpi/prazni_delan_013.png}}
    %\caption{Example torque estimates using DeLaN architecture \emph{without} external forces acting}
    %\label{fig:DeLaNRes}
%\end{figure}
...
\begin{figure}
    ...
    \subfloat[Example from dataset \emph{without} external forces\label{fig:DeLaNResEmpty}]{\includegraphics[width=0.47\textwidth]{slike/mdpi/prazni_delan_002.png}}
    \hfill
    \subfloat[Example from dataset \emph{with} external forces\label{fig:DeLaNResTeret}]{\includegraphics[width=0.47\textwidth]{slike/mdpi/teret_delan_007.png}}
...
\begin{figure}
    \centering
    \subfloat[Convolutional network]{\includegraphics[width=0.47\textwidth]{slike/mdpi/teret_conv_005.png}}
    \hfill
    \subfloat[LSTM network]{\includegraphics[width=0.47\textwidth]{slike/mdpi/teret_lstm_005.png}}
...
\begin{figure}
    \centering
    \subfloat[DeLaN]{\includegraphics[width=0.47\textwidth]{slike/mdpi/franka_delan_005.png}}
    \hfill
    \subfloat[MLP]{\includegraphics[width=0.47\textwidth]{slike/mdpi/franka_mlp_005.png}}
    \vfill
    \subfloat[Convolutional network]{\includegraphics[width=0.47\textwidth]{slike/mdpi/franka_conv_005.png}}
    \hfill
    \subfloat[LSTM network]{\includegraphics[width=0.47\textwidth]{slike/mdpi/franka_lstm_005.png}}
...
\begin{table}
    ...
    \begin{tabular}{ccccc}
        ...
        \textbf{\#} & \textbf{Architecture} & \textbf{Dataset} & \textbf{Test loss} & \textbf{RMSE} \\
        \midrule
        1. & MLP & Real & 1.4113 & 1.0704\\% mlp_sg_01
        2. & Conv & Real & 1.7227 & 1.2055\\ % conv_sg_01
        3. & LSTM & Real & 0.9969 &\textbf{0.8931}\\ % lstm_sg_01
        \bottomrule
    \end{tabular}
\end{table}
