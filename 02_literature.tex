...
\begin{figure}
    \centering
    \subfloat[FOPnet construction]{\includegraphics[width=0.495\textwidth]{slike/FOP1.png}}
    \hfill
    \subfloat[FOPnet for an N-DoF manipulator]{\includegraphics[width=0.495\textwidth]{slike/FOP2.png}}
