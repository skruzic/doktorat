...
\begin{figure}
    ...
    \begin{tikzpicture}
        ...
        \foreach \i in {1,...,3}
        {
            \foreach \j in {1,...,4}
            {
                \draw[->, shorten >=2pt, shorten <=2pt] (Input-\i) -- (Hidden1-\j);   
            }
        }
        ...
        \foreach \i in {1,...,4}
        {
            \foreach \j in {1,...,4}
            {
                \draw[->, shorten >=2pt, shorten <=2pt] (Hidden1-\i) -- (Hidden2-\j);
            }
        }
        ...
        \foreach \i in {1,...,4}
        {
            \foreach \j in {1,...,3}
            {
                \draw[->, shorten >=2pt, shorten <=2pt] (Hidden2-\i) -- (Output-\j);
            }
        }
        
        \node[annot,above of=Input-1, node distance=1cm] {Input};
        \node[annot,above of=Hidden1-1, node distance=1cm] {FC};
        \node[annot,above of=Hidden2-1, node distance=1cm] {FC};
        \node[annot,above of=Output-1, node distance=1cm] {Output};
    \end{tikzpicture}
    \caption{The schematic of the multilayer perceptron architecture}
    \label{fig:MLPArch}
\end{figure}
...
\begin{figure}
    ...
    \begin{tikzpicture}
        ...
        \foreach \i in {1,...,3}
        {
            \foreach \j in {1,...,5}
            {
                \draw[->, shorten >=2pt, shorten <=2pt] (Input-\i) -- (Conv-\j);   
            }
        }
        
        % Strelice Conv->FC1
        \draw[->, shorten >=2pt, shorten <=2pt] (Conv-1) -- (Hidden1-2);
        \draw[->, shorten >=2pt, shorten <=2pt] (Conv-1) -- (Hidden1-5);
        \draw[->, shorten >=2pt, shorten <=2pt] (Conv-1) -- (Hidden1-6);
        \draw[->, shorten >=2pt, shorten <=2pt] (Conv-2) -- (Hidden1-1);
        \draw[->, shorten >=2pt, shorten <=2pt] (Conv-2) -- (Hidden1-4);
        \draw[->, shorten >=2pt, shorten <=2pt] (Conv-3) -- (Hidden1-1);
        \draw[->, shorten >=2pt, shorten <=2pt] (Conv-3) -- (Hidden1-3);
        \draw[->, shorten >=2pt, shorten <=2pt] (Conv-3) -- (Hidden1-5);
        \draw[->, shorten >=2pt, shorten <=2pt] (Conv-3) -- (Hidden1-6);
        \draw[->, shorten >=2pt, shorten <=2pt] (Conv-4) -- (Hidden1-1);
        \draw[->, shorten >=2pt, shorten <=2pt] (Conv-4) -- (Hidden1-2);
        \draw[->, shorten >=2pt, shorten <=2pt] (Conv-4) -- (Hidden1-6);
        \draw[->, shorten >=2pt, shorten <=2pt] (Conv-5) -- (Hidden1-2);
        \draw[->, shorten >=2pt, shorten <=2pt] (Conv-5) -- (Hidden1-3);
        \draw[->, shorten >=2pt, shorten <=2pt] (Conv-5) -- (Hidden1-4);
        \draw[->, shorten >=2pt, shorten <=2pt] (Conv-5) -- (Hidden1-5);
        ...
        \node[annot,above of=Input-1, node distance=1cm] {Input};
        \node[annot,above of=Conv-1, node distance=1cm] {Conv};
        \node[annot,above of=Hidden1-1, node distance=1cm] {FC};
        \node[annot,above of=Hidden2-1, node distance=1cm] {FC};
        \node[annot,above of=Output-1, node distance=1cm] {Output};
    \end{tikzpicture}
